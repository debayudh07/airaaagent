...
export default function GeminiAIAssistant({ researchData, onSuggestionSelect }: GeminiAIAssistantProps) {
  ...
  const callGeminiAPI = async (prompt: string) => {
    ...
    try {
      const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyDCPa0ElH9NwtiUK4guVSR92vICxn_5NTk`, {
        method: 'POST',
        headers: {
